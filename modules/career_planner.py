...
def career_planner_interface():
    with gr.Column() as layout:
        ...
        with gr.Row():
            branch = gr.Dropdown(
                choices=["Computer Science", "Information Technology", "Electronics", "Mechanical", "Civil", "Other"],
                label="Your Branch"
            )
            year = gr.Dropdown(
            ...
            target_company = gr.Textbox(label="Target Company", placeholder="e.g. Google, Amazon, TCS")
        ...
        def generate_plan(branch_val, year_val, company_val):
            ...
            Format the output beautifully with Markdown headers and bullet points.
            """
